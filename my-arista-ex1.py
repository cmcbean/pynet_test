...
From the returned data structure retrieve the prefices, the output interfaces,
and the next hops (if available)

Print these routes and associated information to stdout.
...
def main():
  ...
  filler = "-" * 15
  print "\n{:>15} {:>15} {:>15}".format(filler, filler, filler)
